...
[b]Formati disponibili nella versione corrente:[/b] PNG, JPG, JPEG e WebP.
[color=#E7B64A][b]FORMATI PREVISTI DAL MANUALE[/b][/color] FITS e TIF saranno aggiunti alla procedura di caricamento.
...
[b]Formats available in the current build:[/b] PNG, JPG, JPEG and WebP.
[color=#E7B64A][b]FORMATS PLANNED BY THE MANUAL[/b][/color] FITS and TIF will be added to the loading workflow.
